//pegar o id pelo css usando querySelector
...
//função para mudar de 45mm para 41mm mudando titulo 
function atualizarTamanho() {
    ...
    tituloProduto.innerText="Pulseira loop " + opcoesCores[numCorSelecionada].toLowerCase() + " para caixa de " + tamanhoCaixa;
    // adcionar uma classe no css e a função abaixo para diminuir a escala do 41 e 45 mm 
...
//função para mudar a imagem selecionada (adcionado onclick no html). 
